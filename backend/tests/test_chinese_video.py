...
def main():
    ...
    logger.add(logs_dir / "test_chinese_video.log", rotation="500 MB")
    
    # 读取示例数据
    json_path = root_dir / "data/samples/math_problems/sample_math_problem_004.json"
    ...
    # 设置输出路径
    output_path = output_dir / "test_chinese_video.mp4"
